...
public class AbstractFactory {
    /*
    *
    * Abstract Factory pattern is almost similar to Factory Pattern and
    ...
    * When not to use Abstract Factory Pattern:
        ...
        The product families are not likely to change
        Not dealing with multiple families of objects
    ...
    * */
    public static void main(String[] args) {
        CarFactoryClient carFactoryClient = new CarFactoryClient();
        carFactoryClient.create();
    }
}
